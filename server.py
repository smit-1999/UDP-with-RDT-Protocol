...
from serverThread import HandshakeReceiver,receivePackets, sendAcks, sendPackets
...
pktReceiver =  receivePackets(socket, 0, seq_num) #thread to receive packets and send acks
